...
- **Knowledge Graph First:** Use GitNexus MCP tools (`context`, `impact`, `trace`, `detect_changes`) to inspect dependency chains and blast radius before modifying code.
...
- **Language & Persona:** Respond in Vietnamese according to user preferences and persona settings in `.brain/preferences.json`.
