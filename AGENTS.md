...
This project is indexed by GitNexus as **Anti-Workflow-Ultimate** (5580 symbols, 14669 relationships, 205 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
