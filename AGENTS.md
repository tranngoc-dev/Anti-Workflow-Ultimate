...
This project is indexed by GitNexus as **Anti-Workflow-Ultimate** (1852 symbols, 3211 relationships, 156 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
