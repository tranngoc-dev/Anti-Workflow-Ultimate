export const metadata = {
  ...
  description: 'Tulanh là blog tối giản, tập trung vào nội dung, thiết kế web, frontend và trải nghiệm người dùng.',
};
      ...
      <article className="post-article">
        <header className="post-header">
          ...
          <div className="post-meta">
            <span className="dynamic-site-name">Tulanh</span>
          </div>
        </header>

        <div className="prose">
          <p>
            Tulanh là nơi chia sẻ các ghi chú thực tế về thiết kế web,
